...
public:
    ...
    virtual void addAction(actionOnClick onClickAction, actionOnRelease onReleaseAction);
    virtual void addOnClickAction(actionOnClick onClickAction);
    virtual void addOnReleaseAction(actionOnRelease onReleaseAction);
